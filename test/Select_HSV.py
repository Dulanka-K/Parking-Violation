...
# video = cv2.VideoCapture("ISLab-04.mp4")
...
# Load image
# image = cv2.imread('Image manipulation/image.PNG')
image = cv2.imread('../assets/pettah.jpg')
# image = cv2.imread('frame_10.png')
...
while(1):
    ...
    if((phMin != hMin) | (psMin != sMin) | (pvMin != vMin) | (phMax != hMax) | (psMax != sMax) | (pvMax != vMax) ):
        ...
        pvMax = vMax
    # print(dim)
    # cv2.resizeWindow('image', 733, 600)
    # cv2.resize(result, (733, 600))
